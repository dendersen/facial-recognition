...
modifyOriginals(maximum=400,varients=2)
# Load amount should be half that of modified image lenght or original_lengt * 10 / 2
Network = SiameseNeuralNetwork(person="Christoffer", loadAmount=300, trainDataSize=.7, bachSize=16, addFacesInTheWild=True, resetNetwork=False) 
# Network.train(10)
