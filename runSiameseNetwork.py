...
Network = SiameseNeuralNetwork(person="David", loadAmount=500, trainDataSize=.9, bachSize=16, addFacesInTheWild=True) # Load amount should be half that of modified image lenght
